...
export default function AboutStats() {
  ...
  return (
    // FIX: Added pt-32 on mobile to account for the overlapping HeroBadgeBar
    <section ref={sectionRef} className="w-full bg-[#0B1E3A] pt-32 pb-16 lg:py-16 px-[clamp(1.5rem,5vw,4rem)] border-b-4 border-orange-500">
      
      {/* FIX: Changed grid to sm:grid-cols-2 and increased gap-12 on mobile for better spacing */}
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-6 lg:divide-x divide-white/10">
