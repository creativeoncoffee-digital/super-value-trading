...
export default function WhyUs() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-[linear-gradient(135deg,#084ea3_0%,#0b57a8_55%,#071326_100%)] py-[clamp(4rem,10vw,8rem)] px-[clamp(1.5rem,5vw,4rem)] overflow-hidden brand-section">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 md:gap-24">
        ...
        <div className="flex flex-col w-full lg:w-1/2">
          ...
          <h2 className="why-text-anim text-white font-bold text-3xl md:text-5xl leading-tight mb-12 max-w-xl">
            Why Choose Super Value General Trading LLC
          </h2>

          <ul className="why-text-anim text-white/90 text-md leading-relaxed space-y-6">
            <li className="flex items-start gap-4 rounded-2xl bg-white/6 border border-white/10 p-4 backdrop-blur-sm">
              <span className="brand-icon-chip shrink-0 bg-[#ff7b1c]/15 text-white">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 12h16M12 4v16" /></svg>
              </span>
            ...
            <li className="flex items-start gap-4 rounded-2xl bg-white/6 border border-white/10 p-4 backdrop-blur-sm">
              <span className="brand-icon-chip shrink-0 bg-[#0b57a8]/20 text-white">
            ...
            <li className="flex items-start gap-4 rounded-2xl bg-white/6 border border-white/10 p-4 backdrop-blur-sm">
              <span className="brand-icon-chip shrink-0 bg-white/10 text-white">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2l2.8 7.2L22 12l-7.2 2.8L12 22l-2.8-7.2L2 12l7.2-2.8L12 2z" /></svg>
              </span>
            ...
            <li className="flex items-start gap-4 rounded-2xl bg-white/6 border border-white/10 p-4 backdrop-blur-sm">
              <span className="brand-icon-chip shrink-0 bg-[#f3790a]/20 text-white">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a4 4 0 00-4-4h-1M7 20H2v-2a4 4 0 014-4h1m6-4a4 4 0 100-8 4 4 0 000 8zm-7 4a4 4 0 118 0v2H6v-2z" /></svg>
              </span>
