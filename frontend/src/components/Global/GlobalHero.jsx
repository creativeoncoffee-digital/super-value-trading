      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="hero-content text-5xl md:text-6xl lg:text-[4rem] font-bold text-white leading-[1.1] mb-8">
           A trade network spanning five continents.
          </h1>

          {/* Subtext */}
          <p className="hero-content text-slate-300 text-lg md:text-xl leading-relaxed max-w-2xl">
     From Business Bay in Dubai, our integrated logistics network combines sea, air and land transport to deliver across 90 countries — with comprehensive warehousing and last-mile delivery along the way.
          </p>
