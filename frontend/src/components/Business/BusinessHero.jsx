      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="hero-content text-5xl md:text-6xl lg:text-[4rem] font-bold text-white leading-[1.1] mb-8">
            A diverse trading portfolio across four core sectors.
          </h1>

          {/* Subtext */}
          <p className="hero-content text-slate-300 text-lg md:text-xl leading-relaxed max-w-2xl">
            From grooming essentials to fragrance, specialty consumer goods to automotive parts — each sector is backed by the same sourcing discipline and logistics network.
          </p>
