...
export default function FMCGShowcase({ category = "personal-care" }) {
  ...
  return (
    // FIX: Removed overflow-hidden from the main wrapper to allow ProductShowcase's sticky effect to work
    <div ref={containerRef} className="w-full bg-[#f8fafc] font-sans">
      
      {/* ABOUT SECTION (Added padding and overflow-hidden specifically here) */}
      <section className="fmcg-about-trigger w-full pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
